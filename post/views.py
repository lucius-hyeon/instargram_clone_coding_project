...
def profile(request, nickname):
    ...
    author_bookmark_post = [ mark.post for mark in author.bookmarkmodel_set.all() ]

    author_following_1 = [ men.follow for men in author.user.all() if men.follow in user_followings]
    author_following_0 = [ men.follow for men in author.user.all() if men.follow not in user_followings]
    author_follower_1 = [ men.user for men in author.follow.all() if men.user in user_followings ]
    author_follower_0 = [ men.user for men in author.follow.all() if men.user not in user_followings ]
